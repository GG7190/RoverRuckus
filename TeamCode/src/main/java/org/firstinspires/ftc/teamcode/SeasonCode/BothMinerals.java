...
public class BothMinerals extends LinearOpMode {
           ...
           /* if(!robot.digitalTouch.getState())
            {
                ...
                robot.DriveMotorUsingEncoder(0.25, 2, 8, "driftL");
            }
            ...
            robot.DriveMotorUsingEncoder(0.25, 8, 8, "spinR");
            if (robot.tfod != null) {
                robot.tfod.activate();
            }
    ...
    public void goldMineralRight()
    {
        ...
        robot.DriveMotorUsingEncoder(0.25, 8, 10, "driftR");
        //drive forward towards blocks with harvestor spinning inward
        robot.DriveMotorUsingEncoder(0.25, 8,10, "forward");
        //drive backward away from minerals
        robot.DriveMotorUsingEncoder(0.25, 8, 10, "backward");
